...
license: MIT
compatibility: Requires either Go 1.21+ (go run) or Python 3.11+ with uv or pipx for the fallback CLI.
---
...
```bash
# Preferred
go run github.com/xcapaldi/recipemd-validate@latest <file>

# Fallback (Go unavailable)
uvx recipemd <file>
# or
pipx run recipemd <file>
```
